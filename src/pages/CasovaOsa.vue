...
const skupiny = [
  {
    ...
    kapitoly: [
      {
        id: 1,
        slug: '01_1_samnitska_valka',
        title: '1. samnitská válka',
        years: '343–341 př. n. l.',
      },
      { id: 2, slug: '02_latinska_valka', title: 'Latinská válka', years: '340–338 př. n. l.' },
      {
        id: 3,
        slug: '03_2_samnitska_valka',
        title: '2. samnitská válka',
        years: '326–304 př. n. l.',
      },
    ],
  },
  {
    ...
    kapitoly: [
      {
        id: 4,
        slug: '04_3_samnitska_valka',
        title: '3. samnitská válka',
        years: '298–290 př. n. l.',
      },
  ...
  },
  {
    ...
    kapitoly: [
      {
        id: 8,
        slug: '08_1_makedonska_valka',
        title: '1. makedonská válka',
        years: '214–205 př. n. l.',
      },
      {
        id: 9,
        slug: '09_2_makedonska_valka',
        title: '2. makedonská válka',
        years: '200–196 př. n. l.',
      },
      { id: 10, slug: '10_syrska_valka', title: 'Syrská válka', years: '192–188 př. n. l.' },
      {
        id: 11,
        slug: '11_3_makedonska_valka',
        title: '3. makedonská válka',
        years: '171–168 př. n. l.',
      },
      { id: 12, slug: '12_3_punska_valka', title: '3. punská válka', years: '149–146 př. n. l.' },
      {
        id: 13,
        slug: '13_numantinska_valka',
        title: 'Numantinská válka',
        years: '143–133 př. n. l.',
      },
    ],
  },
  {
    ...
    kapitoly: [
      {
        id: 14,
        slug: '14_jugurthinska_valka',
        title: 'Jugurthinská válka',
        years: '112–105 př. n. l.',
      },
      {
        id: 15,
        slug: '15_valky_s_kimbry_a_teutony',
        title: 'Války s Kimby a Teutony',
        years: '113–101 př. n. l.',
      },
      { id: 16, slug: '16_spojenecka_valka', title: 'Spojenecká válka', years: '91–87 př. n. l.' },
      {
        id: 17,
        slug: '17_sullovy_obcanske_valky',
        title: 'Sullovy občanské války',
        years: '88–81 př. n. l.',
      },
      {
        id: 18,
        slug: '18_sertorijska_valka',
        title: 'Sertorijská válka',
        years: '80–72 př. n. l.',
      },
      {
        id: 19,
        slug: '19_spartakovo_povstani',
        title: 'Spartakovo povstání',
        years: '73–71 př. n. l.',
      },
      {
        id: 20,
        slug: '20_3_mithridatska_valka',
        title: '3. mithridatská válka',
        years: '73–63 př. n. l.',
      },
      {
        id: 21,
        slug: '21_caesarovy_galske_valky',
        title: 'Caesarovy galské války',
        years: '58–50 př. n. l.',
      },
      {
        id: 22,
        slug: '22_caesarova_obcanska_valka',
        title: 'Caesarova občanská válka',
        years: '49–45 př. n. l.',
      },
      {
        id: 23,
        slug: '23_zaverecne_obcanske_valky',
        title: 'Závěrečné občanské války',
        years: '44–31 př. n. l.',
      },
    ],
  },
  {
    ...
    kapitoly: [
      {
        id: 24,
        slug: '24_bitva_v_teutoburskem_lese',
        title: 'Bitva v Teutoburském lese',
        years: '9 n. l.',
      },
  ...
  },
  {
    ...
    kapitoly: [
      ...
      {
        id: 31,
        slug: '31_parthska_valka_traiana',
        title: 'Parthská válka Traiana',
        years: '113–117 n. l.',
      },
...
.kapitola-row { display: flex; align-items: center; gap: 1.5rem; padding: 1rem 1.25rem;
border-bottom: 1px solid rgba(201,168,76,0.12); cursor: pointer; transition: background 0.2s;
text-decoration: none; color: inherit; } @media (min-width: 769px) and (max-width: 1024px) {
.osa-wrap { padding: 4rem 3rem 5rem; } .skupina-label { font-size: 0.58rem; } }
...
.kapitola-row:hover .status-arrow {
  color: var(--text-gold);
}
